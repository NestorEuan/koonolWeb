            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Importe<br>NC</th>
                    ...
                    <?php else : ?>
                        ...
                        <?php foreach ($registros as $r) : ?>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4"><?= number_format(round(floatval($r['nImporteNC']), 2), 2) ?></td>
                                <td class="text-center">
                                    ...
                                    <?php if (intval($r['conFactSinTimbrar']) > 0 && ($r['cEdo'] != '5')) : ?>
                                        ...
                                        <i class="bi bi-file-pluma-solid text-primary me-2 " data-bs-toggle="modal" data-bs-target="#frmModaldf" data-llamar="remisiones/cambiausocfdi/<?= $r['nIdVentas'] ?>/<?= $r['nIdFacturas'] ?>" style="cursor:pointer;" title="Modificar uso de cfdi/fecha"></i>
                                    <?php else : ?>
                                        <i class="bi bi-factura text-secondary me-2 "></i>
                                        <i class="bi bi-file-pluma-solid text-secondary me-2 "></i>
                                    <?php endif; ?>
                                    <a class="bi bi-printer-fill text-primary me-2" href="ventas/imprimeRemision/<?= $r['nIdVentas'] ?>/1/back" style="cursor:pointer;" title="Reimprimir Remision" <?= $esMobil ? 'target="_blank"' : '' ?> ></a>
                                    <?php if ($bndCancela) : ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <?php if (intval($r['nIdFacturas']) > 0 && intval($r['conFactSinTimbrar']) == 0 && ($r['cEdo'] != '5')) : ?>
                                        <i class="bi bi-file-earmark-minus-fill text-primary me-2 " data-bs-toggle="modal" data-bs-target="#frmModal" data-llamar="notacredito/a/<?= $r['nIdVentas'] ?>" style="cursor:pointer;" title="Agregar Nota de Credito"></i>
                                    <?php else : ?>
                                        <i class="bi bi-file-earmark-minus-fill text-secondary me-2 "></i>
                                    <?php endif; ?>
                                    <?php if ($oEntregaModoENV && !in_array($r['cEdo'], ['5', '7'])) : ?>
                                        <i class="bi bi-truck-flatbed text-primary me-2 fw-bold fs-5" data-bs-toggle="modal" data-bs-target="#frmModal" data-llamar="remisiones/entregaModEnv/<?= $r['nIdVentas'] ?>" style="cursor:pointer;" title="Entrega en modo ENV"></i>
                                    <?php else : ?>
                                        <i class="bi bi-truck-flatbet text-secondary me-2 fw-bold"></i>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
