    ...
    <div class="p-2 border rounded row">
        ...
        <form action="<?= $frmURL ?>" method="post" id="addDepAdefrm" onsubmit="return false;">
            ...
            <div class="row mb-1">
                ...
                <div class="col-7" id="ctrlUsoCfdi">
            ...
            onKeydown: function(e) {
                function buscaCodCliente(id) {
                    ...
                    $.post(baseURL + '/cliente/leeRegistro/' + id, {}, null, 'json').
                        ...
                        if (data.ok == '0') {
                            miGlobal.muestraAlerta('Cliente no encontrado', null, 2700);
                        } else {
                            let d = data.registro;
                            if(d.nIdCliente == 1) {
                                miGlobal.muestraAlerta('Cliente no es candidato para un depósito.', null, 700);
                                return;
                            }
