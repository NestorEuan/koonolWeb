                ...
                <td>
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="3" class="text-center fs-8 fw-bold py-0 border-end-0">TOTAL VENTAS</td>
                            ...
                            <?php foreach ($corteResumen['lstPag'] as $v) : ?>
                                <tr>
                                    <td colspan="3" class="text-center py-0 fs-8 py-0 border-end-0"><?= $v['sDescripcion'] ?></td>
                                    <td class="border-start-0"></td>
                                ...
                                ?>
                            <?php endforeach; ?>
                            <?php if ($corteResumen['notasCredito'] > 0) : ?>
                                <tr>
                                    <td colspan="3" class="text-center py-0 fs-8 py-0 border-end-0">Notas de Crédito</td>
                                    <td class="border-start-0"></td>
                                    <td class="text-end py-0 fs-8 py-0">-<?= number_format($corteResumen['notasCredito'], 2) ?></td>
                                </tr>
                                <?php
                                $nSumPagos -= $corteResumen['notasCredito'];
                                ?>
                            <?php endif; ?>
                            <tr>
                                <td colspan="3" class="fs-8 fw-bold py-0 text-center border-end-0">TOTAL FORMAS DE PAGO DE LAS VENTAS</td>
                                <td class="border-start-0"></td>
                                <td class="fs-8 fw-bold py-0 text-end"><?= number_format($nSumPagos, 2) ?></td>
                            </tr>

                            <?php if (count($corteResumen['lstDepNoEfec']) > 0) : ?>
                                <tr>
                                    <td colspan="3" class="fs-7 fw-bold py-0 text-center border-end-0">DEPOSITOS DE CLIENTES (Otras Formas de Pago)</td>
                                    <td class="border-start-0"></td>
                                    <td></td>
                                </tr>

                                <?php foreach ($corteResumen['lstDepNoEfec'] as $v) : ?>
                                    <tr>
                                        <td colspan="3" class="fs-8 fw-bold py-0 text-center">Depósito: <?= esc($v['sNombre'] . ' ' . $v['sObservaciones']) ?></td>
                                        <td class="fs-8 py-0 text-center"><?= esc($v['nomPago']) ?></td>
                                        <td class="text-end fs-8 fw-bold py-0"><?= number_format(floatval($v['nImporte']), 2) ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>

                            <?php if (count($corteResumen['lstESnoEfec']) > 0) : ?>
                                <tr>
                                    <td colspan="5" class="fs-7 fw-bold py-0 text-center border-end-0">INGRESOS A CAJA (Otras Formas de Pago)</td>
                                    <td class="border-start-0"></td>
                                    <td></td>
                                </tr>

                                <?php foreach ($corteResumen['lstESnoEfec'] as $v) : ?>
                                    <?php if ($v['cTipoMov'] == 'S') continue; ?>
                                    <tr>
                                        <td colspan="3" class="text-center fs-8 fw-bold py-0"><?= $v['sMotivo'] ?></td>
                                        <td class="fs-8 py-0 text-center"><?= esc('R-' . $v['nFolioRemision'] . '  ' . $v['nomPago']) ?></td>
                                        <td class="text-end fs-8 fw-bold py-0"><?= number_format(floatval($v['nImporte']), 2) ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
                            ...
                            <tr>
                                <td colspan="3" class="fs-7 fw-bold py-0 text-center border-end-0">
                                    << EFECTIVO EN CAJA>>
                                </td>
                                <td class="border-start-0"></td>
                                <td></td>
                            ...
                            <tr>
                                <td colspan="3" class="fs-8 fw-bold py-0 text-center border-end-0">SALDO INICIAL EN CAJA(+)</td>
                            ...
                            <tr>
                                <td colspan="3" class="fs-8 fw-bold py-0 text-center border-end-0">EFECTIVO COBRADO(+)</td>
                                <td class="border-start-0"></td>
                            ...
                            <?php foreach ($corteResumen['lstES'] as $v) : ?>
                                ...
                                <tr>
                                    <td colspan="3" class="text-center fs-8 fw-bold py-0 border-end-0"><?= $v['sMotivo'] ?></td>
                                    <td class="border-start-0"></td>
                                    <td class="text-end fs-8 fw-bold py-0"><?= number_format(floatval($v['nImporte']), 2) ?></td>
                                </tr>
                            ...
                            <?php endforeach; ?>
                            <tr>
                                <td colspan="3" class="fs-8 fw-bold py-0 text-center border-end-0">GASTOS DEL DIA(-)</td>
                                <td class="border-start-0"></td>
                            ...
                            <?php foreach ($corteResumen['lstDep'] as $v) : ?>
                                <tr>
                                    <td colspan="3" class="fs-8 fw-bold py-0 text-center border-end-0">Depósito: <?= esc($v['sNombre'] . ' ' . $v['sObservaciones']) ?></td>
                                    <td class="border-start-0"></td>
                                    <td class="text-end fs-8 fw-bold py-0"><?= number_format(floatval($v['nImporte']), 2) ?></td>
                                </tr>
                            ...
                            <?php foreach ($corteResumen['lstES'] as $v) : ?>
                                <?php if ($v['cTipoMov'] == 'S') continue; ?>
                                <tr>
                                    <?php if ($v['nFolioRemision'] == '0') : ?>
                                        <td colspan="3" class="text-center fs-8 fw-bold py-0 border-end-0"><?= $v['sMotivo'] ?></td>
                                        <td class="border-start-0"></td>
                                    <?php else : ?>
                                        <td colspan="3" class="text-center fs-8 fw-bold py-0"><?= $v['sMotivo'] ?></td>
                                        <td class="text-center fs-8 py-0">R - <?= $v['nFolioRemision'] ?></td>
                                    <?php endif; ?>
                                    <td class="text-end fs-8 fw-bold py-0"><?= number_format(floatval($v['nImporte']), 2) ?></td>
                                </tr>
                            ...
                            <?php endforeach; ?>
                            <tr>
                                <td colspan="3" class="fs-8 fw-bold py-0 text-center border-end-0">EXTRAS DEL DIA(+)</td>
                                <td class="border-start-0"></td>
                                <td class="fs-8 fw-bold py-0 text-end"><?= number_format($nSum2 + $nSum3, 2) ?></td>
                            </tr>
                            <tr>
                                <td colspan="3" class="fs-8 fw-bold py-0 text-center border-end-0">TOTAL MOVTOS. (1)</td>
                                <td class="border-start-0"></td>
                                <td class="fs-8 fw-bold py-0 text-end"><?= number_format($saldoIni + $nImporteEfectivo + $nSum3 + $nSum2 - $nSum1, 2) ?></td>
                            </tr>
                            <tr>
                                <td colspan="3" class="fs-8 fw-bold py-0 text-center border-end-0">SALDO AL CORTE EN CAJA (2)</td>
                                <td class="border-start-0"></td>
                                <td class="fs-8 fw-bold py-0 text-end"><?= number_format(floatval($corte['nSaldoFin'] ?? 0), 2) ?></td>
                            </tr>
                            <tr>
                                <td colspan="3" class="fs-8 fw-bold py-0 text-center border-end-0">DIFERENCIA: (1) - (2)</td>
                                <td class="border-start-0"></td>
                            ...
                            <?php foreach ($listadoCajero as $v) : ?>
                                <tr>
                                    ...
                                    <?php else : ?>
                                        ...
                                        <td class="text-end fs-8 py-0"><?= number_format(floatval($v['nTotal']) - floatval($v['notaCred']), 2) ?></td>
                                        ...
                                        $sumTota += floatval($v['nTotal']) - floatval($v['notaCred']);
