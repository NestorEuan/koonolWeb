    ...
    <div class="row mt-1 fw-normal border-bottom ">
        <div class="col align-text-top text-center pb-2">
            ...
            <div class="me-4 fs-8 text-center" style="height:30px;margin-left:140px;">
                ...
                <span class="ps-4"></span>
                Peso Carga: <strong><?= round(floatval($dat['fPeso']) / 1000, 3) > 1.00 ? round(floatval($dat['fPeso']) / 1000, 2) . ' Tons' : round(floatval($dat['fPeso']), 2) . 'Kg.' ?></strong>
                <br>
                                    ...
                                    <table class="table table-sm table-borderless w-75 border-bottom border-dark">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="fs-8 fw-bold text-center py-0">ENV</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($r['det'] as $kk => $rr) : ?>
                                                <?php if ($rr['capturada'] <= 0) continue; ?>
                                                <tr>
                                                    ...
                                                    <td class="fs-8 text-center fw-bold py-0"><?= $rr['cModoEnv'] == '1' ? '***' : '' ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
