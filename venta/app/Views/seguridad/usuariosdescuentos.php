<div class="container bg-light mt-4 border">
    ...
    <div class="row border rounded mb-3 py-2">
        <div class="col-sm-7">
            <form class="border rounded" action="<?= base_url('usuario/permisodescuento') ?>" method="get">
            ...
            <table class="table table-striped" id="tbl">
                <thead>
                    <tr>
                        ...
                        <?php endif; ?>
                        <?php if ($permisoCambioClienteRem) : ?>
                            <th class="text-center">Cambiar Cliente<br>Remision</th>
                        <?php endif; ?>
                        <?php if ($permisoCambiaFechaFactura) : ?>
                            <th class="text-center">Cambiar Fecha<br>Factura</th>
                        <?php endif; ?>
                        <?php if ($permisoEntregaModoENV) : ?>
                            <th class="text-center">Entrega<br>modo ENV</th>
                        <?php endif; ?>
                        <th>Sucursal</th>
                    </tr>
                </thead>
                    ...
                    <?php else : ?>
                        <?php foreach ($registros as $r) : ?>
                            <tr>
                                ...
                                <?php if ($permisoCambioClienteRem) : ?>
                                    <td class="text-center">
                                        <input class="form-check-input" type="checkbox" data-llamar="<?= base_url('usuario/activapermitecambiocli/' . $r['nIdUsuario']) ?>" <?= $r['bCambioCliente'] ? 'checked' : '' ?>>
                                    </td>
                                <?php endif; ?>
                                <?php if ($permisoCambiaFechaFactura) : ?>
                                    <td class="text-center">
                                ...
                                <?php if ($permisoEntregaModoENV) : ?>
                                    <td class="text-center">
                                        <input class="form-check-input" type="checkbox" data-llamar="<?= base_url('usuario/activaEntregaEnv/' . $r['nIdUsuario']) ?>" <?= $r['bEntregaModoENV'] ? 'checked' : '' ?>>
                                    </td>
                                <?php endif; ?>
                                <td><?= $r['nomSucursal'] ?></td>
                            </tr>
