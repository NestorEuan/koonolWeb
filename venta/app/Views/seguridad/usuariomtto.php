...
<form action="" method="post" id="addUsuario" onsubmit="return false;">
    ...
    <div class="mb-3">
        <label for="sMailCotizacion" class="form-label">eMail</label>
        <?php generaCampoTexto('sMailCotizacion', $error ?? false, null, $registro ?? null, $modo); ?>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        <?php generaCampoTexto('cEdoBaja', $error ?? false, 'checkbox', $registro ?? null, $modo, '', '', null, '1'); ?>
        <label for="cEdoBaja" class="form-check-label">Usuario inactivo</label>
    </div>
</form>
<hr>
