...
class Facturas extends BaseController
{
    ...
    private function initDatosFactura($idFactura)
    {
        ...
        $aDatosPagos = $this->mdlFactura->getDatosPagos($aDatos[0]['nIdVentas']);
    ...
    private function calculaFactura($idFac, $idFolio, $idVen, $sUUID)
    {
        // calcular la factura
        $aImpuesto = [
            'IVA', '002', 'Traslado', 'Tasa', 0.16, 1.16
        ];
        ...
        for ($nInd = 0; $nInd < $nRegistros; $nInd++) {
            ...
            $nImporteConDescuentoTotal = $nImporte - $nDescuentoTotal;
