            ...
            <?php if (!isset($printerMode)) : ?>
                ...
                <form action="<?= base_url('/movimiento/agregaArticulo/' . $operacion . '/' . strtolower($modo)) ?>" method="get" id="frm00" autocomplete="off">
                    ...
                    <div class="input-group ">
                        ...
                        <input class="form-control text-end" type="text" placeholder="Inv. Físico" aria-label="Cantidad del producto" id="nCant" name="nCant" tabindex="3" data-llamar="ventas/" <?= $deshabilitaCampos ?> />
                    </div>
                </form>
            <?php endif; ?>
                ...
                <table class="<?= $tblClass ?>" id="tbl">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" scope="col">Inv. Físico</th>
                        ...
                        <?php else : ?>
                            <?php foreach ($registros as $r) : ?>
                                ...
                                <tr class="<?= isset($printerMode) ? 'fs-7' : '' ?>">
                                    ...
                                    <?php if ($operacion === 'compra') : ?>
                                        <th class="text-center" scope="col"> <?= $r['fImporte'] ?> </th>
                                    <?php endif; ?>
            ...
            <div class="col" style="max-width: 350px;">
                <div class="container-fluid border rounded pt-3  bg-light">
                    ...
                    <form action='<?= base_url("movimiento/agregaProveedor/$operacion/" . strtolower($modo)) ?>' method="post" id="frmBuscaProveedor" autocomplete="off">
                        ...
                        <?php endif ?>
                        <div class="col">
                            <label for="<?= $datefld ?>" class="form-label">F. de captura de inventario</label>
                            <div class="input-group ">
                    ...
                    <div class="text-center my-1">
                        <?php if ($nCont > 0 && $modo === 'A') : ?>
                            <?php if ($modo !== 'A') : ?>
                                <button class="btn btn-sm btn-outline-danger me-3" id="btnBack">
                    ...
                    if (operacion == 'traspaso' || operacion == 'salida') {
                        ...
                        $.post(baseURL + '/existencia/' + sucursalida + '/' + id, {}, null, 'json').
                            ...
                            if (data.ok === '0') {
                                ...
                                if (parseFloat(data.registro[0].fExistencia) < parseFloat(e.target.value)) {
