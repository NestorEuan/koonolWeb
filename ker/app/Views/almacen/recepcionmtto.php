                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <?php if ($operacion === 'entrega') : ?>
                                            ...
                                            //echo "<script>  window.alert($fMinXRecibir); </script>";
                                            ?>
                                            <input type="text" class="form-control input-sm py-0" id="art-<?= $nCont ?>" data-cantidad="<?= $fMinXRecibir ?>" data-idx=<?= $nCont ?> data-fuente="cantidad" name="<?= $operacion ?>[<?= $r['nIdArticulo'] ?>]" value="<?= $fMinXRecibir ?>" <?= $fMinXRecibir > 0 ? ($operacion === 'entrega' ? 'readonly' : '') : 'readonly' ?>>
                                        <?php else : ?>
        ...
        <div class="col" style="max-width: 350px;">
            <div class="container-fluid border rounded pt-3  bg-light">
                ...
                <div class="text-center my-1">
                    ...
                    <button class="btn btn-sm btn-outline-danger" id="btnBack00">
                        <!-- button class="btn btn-sm btn-outline-success me-3" id="btnGuardar" -->
                        Regresar
                    </button>
                    <?php if ($operacion === 'entrega') : ?>
                        <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#mdConfirma" data-llamar="movimiento/recepcion/entregaC/<?= $registro[$masterkey] ?>" data-mod-msj="Cancelar entrega??" <?= $nRecibidos > 0 ? '' : 'disabled' ?>>
                            <!-- button class="btn btn-sm btn-outline-success me-3" id="btnGuardar" -->
                            Rechazar
                        </button>
                    <?php endif ?>
