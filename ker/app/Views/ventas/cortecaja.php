                        ...
                        <?php foreach ($registros as $r) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php $bHabilitar = ($r['dtCierre'] == null && intval($r['sumFacPendientes']) == 0); ?>
                                    ...
                                    <?php if ($verImprimpirCorte) : ?>
                                        <a class="bi bi-printer-fill text-primary" href="cortecaja/imprime/<?= $r['nIdCorte'] ?>" style="cursor:pointer;<?= (!$bHabilitar || $esUsuarioAdmin || $esEncargado) ? '' : 'visibility:hidden;' ?>" title="Imprimir Corte"></a>
                                    <?php endif; ?>
        ...
        let appCorte = {
            ...
            agregar: function(e) {
                ...
                if (appCorte.aplicaAdd == '1') {
                    if (appCorte.aplicaModID == '0') {
                        cUrl = cUrl + $(e.relatedTarget).data('llamar');
                    } else {
                        cUrl = cUrl + 'cortecaja/e/' + appCorte.aplicaModID;
                    }
                } else {
                    cUrl = cUrl + $(e.relatedTarget).data('llamar');
                }
