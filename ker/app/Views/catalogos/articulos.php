<div class="container bg-light mt-4 border">
    <h4>Articulos</h4>
    <div class="row">
        <form class="col-12 col-md-8 border rounded py-2" action="<?= base_url('articulo') ?>" method="get">
        ...
        <div class="col-12 col-md-4 border rounded py-2" >
            <div class="input-group justify-content-end">
                ...
                <a class="btn btn-primary" href="articulo/imprimir" role="button">Imprimir</a>
            </div>
        </div>
    </div>
...
<?= generaModalGeneral($id = 'frmModal', 'modal-xl') ?>
