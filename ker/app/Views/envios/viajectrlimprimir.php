...
function imprimeCabeceroViaje($titulo, $nFolio, $sChofer)
{
?>
    <div class="row mt-1 fw-normal border-bottom ">
        <div class="col align-text-top text-center pb-2">
            <img src="<?= base_url() ?>/assets/img/<?= $aInfoSis['bannermain']?>" alt="" height="90" class="float-start">
...
<?php imprimeCabeceroViaje('ENVIOS A CLIENTES (COPIA CHOFER)', $nIdViaje, $nomChofer); ?>
...
<?php imprimeCabeceroViaje('ENVIOS A CLIENTES (COPIA BODEGA)', $nIdViaje, $nomChofer); ?>
<table class="<?= $tblClass ?> ">
    <thead>
        <tr>
            <th># Envio</th>
...
<p class="d-none page-break d-sm-block"></p>
<?php imprimeCabeceroViaje('Notas de entrega (COPIA Cliente)', $nIdViaje, $nomChofer); ?>
