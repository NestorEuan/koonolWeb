<?php
$aKeys = [
    'viajectrl' => ['nIdViaje', 'dViaje', 'del chofer'],
];
    ...
    <div class="row h-75">
                        ...
                        <tbody>
                            ...
                            <?php else : ?>
                                <?php foreach ($registros as $r) : ?>
                                    ...
                                    $nKey = $r['nIdEnvio'];
                                    $dMov = $r['dAsignacion'];
                                    //if ($r['nIdViaje'] != null && $r['nIdViaje'] != $registro['nIdViaje']) continue;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($modo === 'V' || $modo === 'I') : ?>
                                                ...
                                                <?php if ($modo !== 'V') : ?>
                                                    <button class="btn  bi-x-lg text-danger btn-link" data-bs-toggle="modal" data-bs-target="#frmMdlViaje" data-llamar="viajectrl/envioctrl/b/<?= $r['nIdEnvio'] ?? 0 ?>/<?= $r['nIdViaje'] === $registro['nIdViaje'] ? $r['nIdViaje'] : 0 ?>/<?= $r['nIdViajeEnvio'] ?? 0 ?>" data-mod-msj="Eliminar envio?" style="cursor:pointer;" <?= $deshabilitaCampos ?> <?= $r['nIdViaje'] === $registro['nIdViaje'] ? '' : 'disabled' ?>></button>
                                                <?php endif; ?>
                                            <?php elseif ($modo === 'C') : ?>
                                                <button class="btn  bi-reply-fill  text-danger btn-link" data-bs-toggle="modal" data-bs-target="#frmMdlViaje" data-llamar="viajectrl/envioctrl/d/<?= $r['nIdEnvio'] ?? 0 ?>/<?= $r['nIdViaje'] === $registro['nIdViaje'] ? $r['nIdViaje'] : 0 ?>/<?= $r['nIdViajeEnvio'] ?? 0 ?>" data-mod-msj="Cargar al?" style="cursor:pointer;" <?= $deshabilitaCampos ?>></button>
                                            <?php endif; ?>
        ...
        <div class="col" style="max-width: 300px;">
            <div class="container-fluid border rounded pt-1 bg-light">
                ...
                <form action='<?= base_url("viajectrl/" . strtolower($modo)) ?>' method="post" id="frmGuardaViaje" autocomplete="off">
                    <div class="col">
